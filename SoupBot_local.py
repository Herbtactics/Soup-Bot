...
async def on_message(message):
    ...
    if soup_channel_id == int(channel_ID) and 'premade' in message.content.lower():
        ...
        await Selenium_local.premade_process()
        await soup_channel.send(Selenium_local.result)
        await soup_channel.send(Selenium_local.result_name)
